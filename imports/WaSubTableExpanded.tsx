import svgPaths from "./svg-59r8571csu";
...
function Frame2037() {
  return (
    <div className="box-border content-stretch flex flex-row gap-2.5 h-[257px] items-center justify-center p-0 relative w-full">
      <div className="flex h-[166.25px] items-center justify-center relative shrink-0 w-[24px]">
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-1 items-center justify-start p-0 relative shrink-0">
      <div
        ...
        style={
          {
            "--transform-inner-width": "345.078125",
      ...
      <div className="absolute inset-0" data-name="Control">
        <div className="absolute inset-[-8.33%_-25%_-41.67%_-25%]">
          <svg
            ...
            viewBox="0 0 36 36"
          >
            <g filter="url(#filter0_dd_13_19755)" id="Control">
            ...
            <defs>
              ...
              >
                ...
                <feMorphology
                  ...
                  operator="erode"
                  radius="2"
                  result="effect1_dropShadow_13_19755"
                />
                <feOffset dy="4" />
                ...
                <feMorphology
                  ...
                  operator="erode"
                  radius="2"
                  result="effect2_dropShadow_13_19755"
                />
                <feOffset dy="2" />
                ...
                />
                <feBlend
                  in2="effect1_dropShadow_13_19755"
                  mode="normal"
                  result="effect2_dropShadow_13_19755"
                />
                <feBlend
                  in="SourceGraphic"
                  in2="effect2_dropShadow_13_19755"
                  mode="normal"
                  result="shape"
                />
              </filter>
...
function PrimaryTableRowMed2() {
  return (
    <div
      className="bg-[#01476f] box-border content-stretch flex flex-col gap-1 items-start justify-start p-0 relative shrink-0 w-[916px]"
      data-name="Primary Table Row Med"
    >
      <div
        aria-hidden="true"
...
function SecondaryTableRowMed() {
  return (
    <div
      className="[grid-area:1_/_1] bg-[#353a40] box-border content-stretch flex flex-col gap-0.5 items-start justify-center ml-0 mt-0 px-0 py-0.5 relative w-[916px]"
...
function SecondaryTableRowMed1() {
  return (
    <div
      className="[grid-area:1_/_1] bg-[#353a40] box-border content-stretch flex flex-col gap-0.5 items-start justify-center ml-0 mt-10 px-0 py-0.5 relative w-[916px]"
      data-name="Secondary Table Row Med"
    >
      <div
        aria-hidden="true"
...
function SecondaryTableRowMed2() {
  return (
    <div
      className="[grid-area:1_/_1] bg-[#353a40] box-border content-stretch flex flex-col gap-0.5 items-start justify-center ml-0 mt-20 px-0 py-0.5 relative w-[916px]"
      data-name="Secondary Table Row Med"
    >
      <div
        aria-hidden="true"
...
function SecondaryTableRowMed3() {
  return (
    <div
      className="[grid-area:1_/_1] bg-[#353a40] box-border content-stretch flex flex-col gap-0.5 items-start justify-center ml-0 mt-[120px] px-0 py-0.5 relative w-[916px]"
      data-name="Secondary Table Row Med"
    >
      <div
        aria-hidden="true"
...
function SecondaryTableRowMed4() {
  return (
    <div
      className="[grid-area:1_/_1] bg-[#353a40] box-border content-stretch flex flex-col gap-0.5 items-start justify-center ml-0 mt-40 px-0 py-0.5 relative w-[916px]"
      data-name="Secondary Table Row Med"
    >
      <div
        aria-hidden="true"
...
function SecondaryTableRowMed5() {
  return (
    <div
      className="[grid-area:1_/_1] bg-[#353a40] box-border content-stretch flex flex-col gap-0.5 items-start justify-center ml-0 mt-[200px] px-0 py-0.5 relative w-[916px]"
      data-name="Secondary Table Row Med"
    >
      <div
        aria-hidden="true"
...
function SecondaryTableRowMed6() {
  return (
    <div
      className="[grid-area:1_/_1] bg-[#353a40] ml-0 mt-60 relative w-[916px]"
      data-name="Secondary Table Row Med"
    >
...
function SecondaryTableRowMed7() {
  return (
    <div
      className="[grid-area:1_/_1] bg-[#353a40] box-border content-stretch flex flex-col gap-0.5 items-start justify-center ml-0 mt-[280px] px-0 py-0.5 relative w-[916px]"
      data-name="Secondary Table Row Med"
    >
      <div
        aria-hidden="true"
...
function SecondaryTableRowMed8() {
  return (
    <div
      className="[grid-area:1_/_1] bg-[#353a40] box-border content-stretch flex flex-col gap-0.5 items-start justify-center ml-0 mt-80 px-0 py-0.5 relative w-[916px]"
      data-name="Secondary Table Row Med"
    >
      <div
        aria-hidden="true"
...
function SecondaryTableRowMed9() {
  return (
    <div
      className="[grid-area:1_/_1] bg-[#353a40] box-border content-stretch flex flex-col gap-0.5 items-start justify-center ml-0 mt-[360px] px-0 py-0.5 relative w-[916px]"
      data-name="Secondary Table Row Med"
    >
      <div
        aria-hidden="true"
...
function SecondaryTableRowMed10() {
  return (
    <div
      className="[grid-area:1_/_1] bg-[#353a40] box-border content-stretch flex flex-col gap-0.5 items-start justify-center ml-0 mt-[400px] px-0 py-0.5 relative w-[916px]"
      data-name="Secondary Table Row Med"
    >
      <div
        aria-hidden="true"
...
function SecondaryTableRowMed11() {
  return (
    <div
      className="[grid-area:1_/_1] bg-[#353a40] box-border content-stretch flex flex-col gap-0.5 items-start justify-center ml-0 mt-[440px] px-0 py-0.5 relative w-[916px]"
      data-name="Secondary Table Row Med"
    >
      <div
        aria-hidden="true"
...
function SecondaryTableRowMed12() {
  return (
    <div
      className="[grid-area:1_/_1] bg-[#353a40] box-border content-stretch flex flex-col gap-0.5 items-start justify-center ml-0 mt-[480px] px-0 py-0.5 relative w-[916px]"
      data-name="Secondary Table Row Med"
    >
      <div
        aria-hidden="true"
...
function Frame2111() {
  return (
    <div className="box-border content-stretch flex flex-col items-start justify-start p-0 relative shrink-0">
      ...
      <PrimaryTableRowMed4 />
      <div
        className="absolute inset-[9.88%_82.75%_88.95%_16.16%]"
      ...
      <div
        className="absolute inset-[16.39%_82.75%_82.44%_16.16%]"
        data-name="-g-ic_info_gray"
      >
        <svg
          className="block size-full"
      ...
      <div
        className="absolute inset-[22.79%_82.75%_76.05%_16.16%]"
        data-name="-g-ic_info_gray"
      >
        <svg
          className="block size-full"
      ...
      <div
        className="absolute inset-[89.53%_83.3%_9.3%_15.61%]"
        data-name="-g-ic_info_gray"
      >
        <svg
          className="block size-full"
      ...
      <div
        className="absolute inset-[95.93%_83.3%_2.91%_15.61%]"
        data-name="-g-ic_info_gray"
      >
        <svg
          className="block size-full"
...
function Frame2112() {
  return (
    <div className="box-border content-stretch flex flex-row gap-6 items-start justify-start p-0 relative shrink-0 w-[1855px]">
...
function Content2() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col gap-6 items-start justify-start left-[7px] pb-6 pl-6 pr-8 pt-5 top-16 w-[1913px]"
      data-name="Content"
    >
      <WaActive />
      <Header />
...
export default function WaSubTableExpanded() {
  return (
    <div
      className="bg-[#090909] relative size-full"
      data-name="WA- sub table expanded"
    >
      <Content2 />
      <TopNavLogo />
    </div>
